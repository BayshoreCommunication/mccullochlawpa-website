...
export interface FDCourtsCitiesSectionProps {
  title?: string;
...
export default function FDCourtsCitiesSection({
  ...
  bannerImagePath = "/images/seo-services/fraud-defense-lawyer-tampa/courts-cities-banner.png",
}: FDCourtsCitiesSectionProps) {
  return (
