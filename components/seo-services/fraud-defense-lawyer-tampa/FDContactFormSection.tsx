...
export interface FDContactFormSectionProps {
  title?: string;
...
const benefits = [
  ...
  },
  {
    ...
    desc: "Drew McCulloch evaluates your fraud defense options.",
  },
  {
    icon: <FaBolt className="w-4 h-4 text-primary" />,
    title: "Swift Response",
    desc: "Early intervention protects your liberty & legacy.",
  },
];

export default function FDContactFormSection({
  title = "Get a Free, Confidential Case Review from a Tampa Fraud Defense Lawyer",
  highlightedText = "FREE CASE REVIEW",
  paragraph = "Protect your future with an experienced fraud defense lawyer Tampa. A Swift Response from Our Team is the Best Strategy for Building Your Defense.",
  phoneNumber = "(813) 444-2817",
  phoneHref = "tel:8134442817",
}: FDContactFormSectionProps) {
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
                  Confidential Fraud Case Evaluation
                </h3>
                <div className="w-10 h-[2px] bg-primary rounded-full mx-auto my-3" />
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and Former Prosecutor Drew McCulloch will review your fraud case details.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-10 space-y-4">
                  ...
                  <p className="text-slate-400 text-sm text-center max-w-xs">
                    Our fraud defense team will review your situation confidentially.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <select
                    ...
                    className="w-full bg-[#162438] border border-slate-600/60 text-slate-400 text-sm px-4 py-3 rounded-xl focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/40 transition-all appearance-none cursor-pointer"
                  >
                    <option value="" disabled>Type of Fraud Allegation</option>
                    <option value="tax" className="text-white bg-[#162438]">Tax Fraud Allegations</option>
                    <option value="corporate" className="text-white bg-[#162438]">Corporate Fraud Allegations</option>
                    <option value="federal" className="text-white bg-[#162438]">Federal Fraud Allegations</option>
                    <option value="identity-document" className="text-white bg-[#162438]">Identity and Document Fraud</option>
                    <option value="other" className="text-white bg-[#162438]">Other Financial / White Collar Charge</option>
                  </select>

                  <textarea
                    name="caseDescription"
                    placeholder="Briefly describe your fraud allegation or investigation details (optional & confidential)"
                  ...
                  >
                    GET MY FREE CONFIDENTIAL REVIEW
                  </button>
                  ...
                  <div className="flex items-center justify-center gap-3 text-slate-400 text-xs flex-wrap">
                    ...
                    <span className="text-slate-600">•</span>
                    <span>Former Prosecutor Defense</span>
                  </div>
                </form>
              )}
            </div>
