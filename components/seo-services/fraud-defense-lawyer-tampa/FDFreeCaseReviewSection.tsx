...
export interface FDFreeCaseReviewSectionProps {
  title?: string;
  paragraph1?: string;
  paragraph2?: string;
  phoneNumber?: string;
...
export default function FDFreeCaseReviewSection({
  title = "Charged With Fraud in Tampa? The First 48 Hours Are Critical, Contact McCulloch Law Now",
  paragraph1 = "The first 48 hours after a fraud allegation is very important. Contacting a fraud defense lawyer Tampa right away gives you time to build a defense.",
  paragraph2 = "McCulloch Law is available 24 hours a day, 7 days a week. Call (813) 444-2817 for a free, confidential consultation. Our office sits at 238 East Davis Boulevard, Suite 202, Tampa, Florida 33606. We are ready to start protecting your rights today.",
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end relative">
              <div className="relative w-full max-w-[280px] h-[340px] sm:h-[400px] flex items-end justify-center">
                <Image
                  ...
                  alt="Drew McCulloch - Tampa Fraud Defense Lawyer"
                  fill
