...
export interface FDServesSectionProps {
  title?: string;
  subTitle?: string;
...
export default function FDServesSection({
  title = "Fraud Defense Charges, Courts, and Cities McCulloch Law Serves Across Tampa",
  subTitle = "McCulloch Law represents clients across the immediate Tampa area in both personal injury and criminal defense. We focus strictly on local courts to ensure dedicated representation.",
  personalInjuryList = defaultPersonalInjury,
  criminalDefenseList = defaultCriminalDefense,
}: FDServesSectionProps) {
  return (
