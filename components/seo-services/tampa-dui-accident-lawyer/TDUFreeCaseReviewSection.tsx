...
export interface TDUFreeCaseReviewSectionProps {
  title?: string;
  paragraph?: string;
  phoneNumber?: string;
...
export default function TDUFreeCaseReviewSection({
  title = "Arrested for DUI After an Accident in Tampa? Call McCulloch Law",
  paragraph = "Facing drunk driving charges after a traffic accident requires fast legal action to protect your freedom. The ten day administrative window following an arrest represents your only chance to save your driver's license. Attorney Drew McCulloch brings prosecutorial experience, trial skills and dedicated personal representation to your case. Contact McCulloch Law, P.A. today to schedule your free case evaluation with an experienced Tampa DUI accident lawyer.",
