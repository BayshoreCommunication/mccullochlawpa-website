...
export interface TDUContactFormSectionProps {
  title?: string;
...
const benefits = [
  ...
  },
  {
    ...
    desc: "No intake reps. Talk to a lawyer directly.",
  },
  {
    icon: <FaBolt className="w-4 h-4 text-primary" />,
    title: "Immediate Action",
    desc: "We act quickly before your court date.",
  },
];

export default function TDUContactFormSection({
  title = "Get a Free Case Consultation From Tampa DUI Accident Attorney",
  highlightedText = "FREE CASE CONSULTATION",
  paragraph = "Every hour after a Tampa DUI accident arrest works in prosecutor's favor. If you were arrested after a crash, call McCulloch Law at (813) 444-2817 now for a free, confidential case review with Attorney Drew McCulloch.",
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
                  Tell Us About Your DUI Arrest
                </h3>
                <div className="w-10 h-[2px] bg-primary rounded-full mx-auto my-3" />
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and an experienced Tampa DUI accident attorney will review your case.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-10 space-y-4">
                  ...
                  <p className="text-slate-400 text-sm text-center max-w-xs">
                    Attorney Drew McCulloch will review your case details confidentially.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <textarea
                    ...
                    placeholder="Briefly describe your arrest details (optional & confidential)"
