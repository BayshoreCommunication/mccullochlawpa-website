...
export interface TDUHeroSectionProps {
  bgImagePath?: string;
...
export default function TDUHero({
  ...
  paragraph1 = "When a motor vehicle collision leads to drunk driving allegations in Hillsborough County, you face swift legal actions. You risk losing your driver's license while fighting criminal charges in local courts. At McCulloch Law, P.A., our defense team fights to protect your freedom and keep you driving. Attorney Drew McCulloch uses his former prosecutor background to challenge the state's case against you. Hiring an experienced tampa dui accident lawyer gives you a strong shield against life altering penalties. Call us before your first court date and protect your license, your record and your future.",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-800">
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4 first:pl-0">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Tampa DUI Accident <br className="hidden sm:inline" /> Defense Attorney
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Former Prosecutor <br className="hidden sm:inline" /> Trial Strategy
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Protect License &amp; <br className="hidden sm:inline" /> Driving Privileges
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                100+ Verdicts &amp; <br className="hidden sm:inline" /> Jury Selection Experience
              </span>
            </div>
          </div>
        </div>
