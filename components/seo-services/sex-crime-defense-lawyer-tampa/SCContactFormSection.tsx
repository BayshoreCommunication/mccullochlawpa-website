...
export interface SCContactFormSectionProps {
  title?: string;
...
const benefits = [
  ...
  },
  {
    ...
    desc: "Your privacy is fully protected.",
  },
  {
  ...
  },
  {
    ...
    desc: "We act fast before formal charges land.",
  },
];

export default function SCContactFormSection({
  title = "Get a Free, Confidential Case Review From Sex Crime Defense Lawyer, Tampa",
  highlightedText = "FREE CASE REVIEW",
  paragraph = "Your reputation and freedom are too important to leave to chance. Contact us today with an experienced sex crime defense lawyer tampa and start building your strategy.",
  phoneNumber = "(813) 444-2817",
  phoneHref = "tel:8134442817",
}: SCContactFormSectionProps) {
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and an experienced sex crime defense attorney will review your case confidentially.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-10 space-y-4">
                  ...
                  <p className="text-slate-400 text-sm text-center max-w-xs">
                    A McCulloch Law attorney will review your case details confidentially.
                  </p>
                </div>
              ) : (
