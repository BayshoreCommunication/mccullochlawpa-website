...
export interface SCCourtsCitiesSectionProps {
  title?: string;
...
export default function SCCourtsCitiesSection({
  ...
  bannerImagePath = "/images/seo-services/sex-crime-defense-lawyer-tampa/courts-cities-banner.png",
}: SCCourtsCitiesSectionProps) {
  return (
