...
export interface CDContactFormSectionProps {
  title?: string;
...
const benefits = [
  {
    ...
    desc: "No fees. Confidential review of arrest report & bond.",
  },
  {
  ...
  },
  {
    ...
    desc: "Former prosecutor handling your defense.",
  },
  {
    icon: <FaBolt className="w-4 h-4 text-primary" />,
    title: "Immediate Response",
    desc: "Fast action before 24-hour court appearance.",
  },
];

export default function CDContactFormSection({
  title = "Get a Free, Confidential Case Review From Criminal Defense Lawyer, Tampa",
  highlightedText = "FREE CASE REVIEW",
  paragraph = "McCulloch Law offers a free, confidential initial case review of arrest report, bond, and charges at no cost. Talk to a seasoned criminal defense lawyer in Tampa FL before you answer more police questions.",
  phoneNumber = "(813) 444-2817",
  phoneHref = "tel:8134442817",
}: CDContactFormSectionProps) {
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and an experienced Tampa criminal defense attorney will review your case confidentially.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-10 space-y-4">
                  ...
                  <p className="text-slate-400 text-sm text-center max-w-xs">
                    Attorney Drew McCulloch will review your arrest details confidentially.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <select
                    ...
                    className="w-full bg-[#162438] border border-slate-600/60 text-slate-400 text-sm px-4 py-3 rounded-xl focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/40 transition-all appearance-none cursor-pointer"
                  >
                    <option value="" disabled>Are you currently facing charges or investigation?</option>
                    <option value="yes" className="text-white bg-[#162438]">Yes, I have been charged</option>
                    <option value="investigation" className="text-white bg-[#162438]">I am under investigation</option>
                  ...
                  <textarea
                    ...
                    placeholder="Briefly describe your case (optional & confidential)"
