...
export interface CDTestimonialsSectionProps {
  title?: string;
  subTitle?: string;
...
const defaultTestimonials: TestimonialItem[] = [
  ...
  },
  {
    ...
    name: "Nelson P.",
    rating: 5,
    text: "I’m really grateful as to how diligent your law office responded to my traffic ticket and giving me confidence to fight that ticket on my behalf. Thank you for staying on top of your game and even though you don’t have control as to how things may turn out, I feel that I wasn’t another number and because of your law firm I feel vindicated",
  },
];

export default function CDTestimonialsSection({
  title = "What Clients Say About McCulloch Law",
  subTitle = "REAL REVIEWS FROM TAMPA CLIENTS",
  testimonials = defaultTestimonials,
}: CDTestimonialsSectionProps) {
