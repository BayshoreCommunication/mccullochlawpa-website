...
export interface CILApartSectionProps {
  title?: string;
  rows?: ApartRow[];
}
...
const defaultRows: ApartRow[] = [
  {
    feature: "Case volume",
    mcculloch: "A selective, limited caseload",
    others: "Thousands of files running at once",
  },
  {
    feature: "Track record",
    mcculloch: "Over $2 billion recovered in verdicts and settlements",
    others: "Marketing claims with no verdict history",
  },
  {
    feature: "Medical expert",
    mcculloch: "Neurologists at Tampa General and USF Health",
    others: "Whatever expert happens to be available",
  },
  {
    feature: "Future cost planning",
    mcculloch: "Certified life care planners project decades of expenses",
    others: "A flat, one time settlement estimate",
  },
  {
    feature: "Direct lawyer access",
    mcculloch: "Drew McCulloch, from intake through trial",
    others: "A case manager until trial nears",
  },
  {
    feature: "Local standing",
    mcculloch: "Board member, Hillsborough County Bar Association YLD",
    others: "An out of town referral service",
  },
];

export default function CILApartSection({
            ...
            <thead>
              <tr className="bg-[#081524] text-white">
                <th className="py-4 px-6 text-sm sm:text-base font-bold uppercase tracking-wider">
                  What matters in catastrophic case
                </th>
