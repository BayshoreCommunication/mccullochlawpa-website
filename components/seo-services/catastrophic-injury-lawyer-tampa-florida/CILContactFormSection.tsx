...
export interface CILContactFormSectionProps {
  title?: string;
...
export default function CILContactFormSection({
  title = "Get a Free Case Review From Tampa Catastrophic Injury Attorney, Florida",
  highlightedText = "FREE CASE REVIEW",
  paragraph = "Your case certainly has a deadline. One call with McCulloch Law identifies what your injury is worth and what damages you can claim immediately.",
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
                  Tell Us About Your Catastrophic Injury Case
                </h3>
                <div className="w-10 h-[2px] bg-primary rounded-full mx-auto my-3" />
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and an experienced Tampa catastrophic injury lawyer will review your claim.
                </p>
              </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <textarea
                    ...
                    placeholder="Briefly describe your injury and accident details (optional & confidential)"
