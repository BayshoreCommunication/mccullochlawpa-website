...
export interface CILFreeCaseReviewSectionProps {
  title?: string;
  paragraph?: string;
  phoneNumber?: string;
...
export default function CILFreeCaseReviewSection({
  title = "Suffered a Catastrophic Injury in Tampa? Get Your Free Consultation Today",
  paragraph = "Securing financial recovery after a permanent catastrophic injury requires taking legal action right away. This protects physical evidence, interviews witnesses and preserves your legal rights. Call McCulloch Law for a free no obligation case review. We are here to help you get the justice you deserve. We can be reached at (813) 444-2817 or at 238 East Davis Boulevard Tampa.",
