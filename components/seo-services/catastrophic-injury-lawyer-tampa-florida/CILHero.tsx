...
export interface CILHeroSectionProps {
  bgImagePath?: string;
...
export default function CILHero({
  ...
  paragraph1 = "Only personal injury lawyers and victims know catastrophic injury doesn't heal on an insurance company's timeline. Brain injuries, spinal cord damage and severe burns often need years of treatment with high costs. For over 15 years, McCulloch Law’s legal team has been fighting for accident victims in Florida and recovered over $2 billion in verdicts and settlements. Let our catastrophic injury lawyer tampa florida handle your case if you’ve been injured due to someone else’s negligence.",
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex flex-col items-center justify-end relative min-h-[380px] sm:min-h-[460px] md:min-h-[520px] lg:min-h-[580px]">
            <div className="relative w-full h-[380px] sm:h-[460px] md:h-[520px] lg:h-[580px] flex items-end justify-center lg:justify-start lg:pl-2 xl:pl-6">
              <Image
                src={personImagePath}
                alt="Catastrophic Injury Lawyer Tampa Florida"
                fill
                priority
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-800">
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4 first:pl-0">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Catastrophic Injury <br className="hidden sm:inline" /> Lawyers Tampa
              </span>
            </div>
