...
import { FaCalendarAlt, FaShieldAlt, FaBriefcaseMedical, FaUserShield, FaBalanceScale } from "react-icons/fa";
import { FaFileCircleCheck } from "react-icons/fa6";

export interface BPIHeroSectionProps {
  bgImagePath?: string;
...
export default function BPIHero({
  ...
  paragraph1 = "A serious injury can leave you facing medical bills, missed work, insurance calls and uncertainty. Without personal injury lawyer, adjusters lowball your claim while medical bills, lost wages and Florida's $10,000 PIP cap pile up fast. Our firm gives each injury claim direct attorney attention. We replace your voicemail to the insurance company with a demand letter backed by hard evidence. Our attorney Drew McCulloch has more than 100 jury selections and over 100 cases tried to verdict as a former Hillsborough County prosecutor. If you are searching for the best tampa personal injury lawyer, give us a call. We identify every valid source of compensation and protect your rights throughout the claim.",
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex flex-col items-center justify-end relative min-h-[380px] sm:min-h-[460px] md:min-h-[520px] lg:min-h-[580px]">
            <div className="relative w-full h-[380px] sm:h-[460px] md:h-[520px] lg:h-[580px] flex items-end justify-center lg:justify-start lg:pl-2 xl:pl-6">
              <Image
                src={personImagePath}
                alt="Best Tampa Personal Injury Lawyer"
                fill
                priority
              ...
              <div className="absolute right-2 sm:right-4 lg:right-0 xl:right-2 bottom-3 sm:bottom-6 md:bottom-8 lg:top-[34%] xl:top-[36%] lg:bottom-auto w-[210px] sm:w-[250px] md:w-[270px] lg:w-[270px] bg-[#0A1828]/90 backdrop-blur-md border border-primary/40 rounded-2xl p-3.5 sm:p-4 md:p-5 shadow-2xl text-white z-30 space-y-3 sm:space-y-4 transition-all duration-300 hover:border-primary/70">
                ...
                <div className="flex items-start gap-3">
                  <div className="p-2.5 rounded-lg bg-primary/20 border border-primary/40 text-primary shrink-0 mt-0.5">
                    <FaBriefcaseMedical className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <h4 className="text-xs sm:text-sm font-semibold text-slate-100 leading-snug">
                      Get Full Value
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1 flex flex-col justify-center py-4 lg:py-6 pb-8 lg:pb-12">
            <h1 className="tracking-tight text-slate-900 font-bold mb-5">
              ...
              <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-[44px] xl:text-[48px] text-primary leading-snug mt-2">
                {highlightTitle}
              </span>
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-800">
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4 first:pl-0">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Best Tampa Personal <br className="hidden sm:inline" /> Injury Lawyers
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Former Prosecutor <br className="hidden sm:inline" /> Trial Experience
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Demand Letters Backed <br className="hidden sm:inline" /> By Hard Evidence
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Zero Upfront Fees <br className="hidden sm:inline" /> Contingency Basis
              </span>
            </div>
          </div>
        </div>
