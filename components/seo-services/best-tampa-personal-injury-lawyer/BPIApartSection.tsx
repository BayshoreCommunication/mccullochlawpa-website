...
export interface BPIApartSectionProps {
  title?: string;
  rows?: ApartRow[];
}
...
const defaultRows: ApartRow[] = [
  {
    feature: "Direct case handle",
    mcculloch: "Attorney Drew McCulloch, direct and involved",
    others: "A rotating case manager or paralegal",
  },
  {
    feature: "Trial record",
    mcculloch: "100+ jury trials, 100+ cases to verdict",
    others: "A settlement only track record",
  },
  {
    feature: "Insurance policy checked",
    mcculloch: "Bodily injury, umbrella and uninsured motorist coverage",
    others: "Just the primary policy limit",
  },
  {
    feature: "Local court experience",
    mcculloch: "Regular appearances at George Edgecomb Courthouse",
    others: "Attorneys unfamiliar with local judges",
  },
  {
    feature: "Evidence collection speed",
    mcculloch: "Investigators sent out within days of the crash",
    others: "Files sit untouched for weeks",
  },
  {
    feature: "Pricing",
    mcculloch: "Free consultation, contingency fee only",
    others: "Same pitch, slower follow through",
  },
];

export default function BPIApartSection({
