...
export interface BPIContactFormSectionProps {
  title?: string;
...
const benefits = [
  {
    ...
    desc: "No upfront fees. Contingency basis.",
  },
  {
  ...
  },
  {
    ...
    desc: "We start reviewing your case right away.",
  },
];

export default function BPIContactFormSection({
  title = "Get a Free, Confidential Case Review From a Tampa Personal Injury Lawyer",
  highlightedText = "FREE CASE REVIEW",
  paragraph = "McCulloch Law provides free consultations to qualified personal injury clients and works on a contingency fee basis. We can review your accident, injuries, insurance coverage, available evidence and potential legal options. Call our Tampa office today to discuss your accident details.",
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and an experienced Tampa personal injury lawyer will review your claim.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-10 space-y-4">
                  ...
                  <p className="text-slate-400 text-sm text-center max-w-xs">
                    Attorney Drew McCulloch will review your injury claim details confidentially.
                  </p>
                </div>
              ) : (
