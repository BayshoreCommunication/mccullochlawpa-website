...
export interface PICourtsCitiesSectionProps {
  title?: string;
...
export default function PICourtsCitiesSection({
  ...
  bannerImagePath = "/images/seo-services/best-personal-injury-lawyer-tampa-car-accidents/courts-cities-banner.png",
}: PICourtsCitiesSectionProps) {
  return (
