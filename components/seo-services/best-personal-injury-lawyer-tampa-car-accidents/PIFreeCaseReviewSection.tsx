...
export interface PIFreeCaseReviewSectionProps {
  title?: string;
  paragraph1?: string;
  paragraph2?: string;
  phoneNumber?: string;
...
export default function PIFreeCaseReviewSection({
  title = "Injured in a Tampa Car Accident? Contact McCulloch Law Now",
  paragraph1 = "Every day you wait, evidence fades and your deadline gets one day closer. Call McCulloch Law now for a free review of your accident case. You pay nothing unless the firm wins compensation for your injuries and losses. Talk to the best personal injury lawyer tampa car accidents victims call first.",
  paragraph2 = "",
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end relative">
              <div className="relative w-full max-w-[280px] h-[340px] sm:h-[400px] flex items-end justify-center">
                <Image
                  ...
                  alt="Drew McCulloch - Tampa Personal Injury Lawyer"
                  fill
