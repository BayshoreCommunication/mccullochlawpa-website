...
import { FaCalendarAlt, FaShieldAlt, FaCar, FaUserShield, FaBalanceScale } from "react-icons/fa";
import { FaFileCircleCheck } from "react-icons/fa6";

export interface PIHeroSectionProps {
  bgImagePath?: string;
...
export default function PIHero({
  bgImagePath = "/images/seo-services/best-personal-injury-lawyer-tampa-car-accidents/hero-bg.png",
  personImagePath = "/images/hero/Attorney.png",
  titleLine1 = "Best Tampa Personal Injury Lawyer For Car Accidents —",
  titleLine2 = "",
  highlightTitle = "Get Your Rightful Compensation Before Insurer Lowballs You",
  paragraph1 = "Insurance adjusters want you to settle quickly for a fraction of your worth. McCulloch Law is the best personal injury lawyer tampa car accidents victims can hire. We stop insurers from rushing you toward that quick settlement. Our Attorney Drew McCulloch protects your financial recovery through demanding maximum payouts from stubborn insurance companies. Do not let corporate tactics minimize your pain, medical bills, and lost wages today.",
  paragraph2,
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex flex-col items-center justify-end relative min-h-[380px] sm:min-h-[460px] md:min-h-[520px] lg:min-h-[580px]">
            <div className="relative w-full h-[380px] sm:h-[460px] md:h-[520px] lg:h-[580px] flex items-end justify-center lg:justify-start lg:pl-2 xl:pl-6">
              <Image
                src={personImagePath}
                alt="Tampa Personal Injury Lawyer Drew McCulloch"
                fill
                priority
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-800">
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4 first:pl-0">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-primary/15 border-2 border-primary flex items-center justify-center text-primary shrink-0 shadow-inner">
                <FaCar className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Tampa Car Accident <br className="hidden sm:inline" /> Injury Lawyer
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                No Fee Unless <br className="hidden sm:inline" /> We Win Your Case
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Maximum Financial <br className="hidden sm:inline" /> Payout Recovery
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Aggressive Trial <br className="hidden sm:inline" /> Litigation Strategy
              </span>
            </div>
          </div>
        </div>
