...
export interface TDCContactFormSectionProps {
  title?: string;
...
const benefits = [
  ...
  },
  {
    ...
    desc: "No intake reps. Talk to Drew McCulloch directly.",
  },
  {
...
export default function TDCContactFormSection({
  title = "Get a Free, Confidential Case Review From Drug Crimes Defense Lawyer, Tampa",
  highlightedText = "FREE CASE REVIEW",
  paragraph = "Call (813) 444-2817 and speak directly with attorney Drew McCulloch today. Every consultation stays confidential.",
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and attorney Drew McCulloch will review your case confidentially.
                </p>
              </div>
