...
export interface TDCHeroSectionProps {
  bgImagePath?: string;
...
export default function TDCHero({
  ...
  paragraph1 = "Possession, trafficking or federal drug charge can move fast through Hillsborough County. Every statement of yours at Orient Road Jail can impact your entire outcome. The first call you make is more important than the Tampa Police report. Attorney Drew McCulloch spent years as a Tampa Assistant State Attorney, selecting more than 75 juries. As a tampa drug crimes lawyer, Drew reads every police report for weak points. Hire a criminal defense lawyer before your drug charge becomes a felony.",
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex flex-col items-center justify-end relative min-h-[380px] sm:min-h-[460px] md:min-h-[520px] lg:min-h-[580px]">
            <div className="relative w-full h-[380px] sm:h-[460px] md:h-[520px] lg:h-[580px] flex items-end justify-center lg:justify-start lg:pl-2 xl:pl-6">
              <Image
                src={personImagePath}
                alt="Tampa Drug Crimes Defense Lawyer"
                fill
                priority
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1 flex flex-col justify-center py-4 lg:py-6 pb-8 lg:pb-12">
            <h1 className="tracking-tight text-slate-900 font-bold mb-5">
              ...
              <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-[46px] xl:text-[50px] text-primary leading-snug mt-2">
                {highlightTitle}
              </span>
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-800">
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4 first:pl-0">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Local Tampa <br className="hidden sm:inline" /> Drug Crimes Lawyers
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Former Assistant <br className="hidden sm:inline" /> State Attorney
              </span>
            </div>
