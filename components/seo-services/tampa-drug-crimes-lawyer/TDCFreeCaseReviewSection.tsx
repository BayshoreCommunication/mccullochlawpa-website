...
export interface TDCFreeCaseReviewSectionProps {
  title?: string;
  paragraph?: string;
  phoneNumber?: string;
...
export default function TDCFreeCaseReviewSection({
  title = "Charged With Drug Crimes in Tampa? Contact McCulloch Law Now",
  paragraph = "Every hour after your arrest is an hour the state spends building its file. Call (813) 444-2817 now and put a Tampa drug crimes lawyer on your side. McCulloch Law, P.A. sits at 238 E Davis Blvd, Suite 202 Tampa, FL 33606. Consultations stay free and confidential, every single time, for every caller.",
