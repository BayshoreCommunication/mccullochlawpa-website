...
export interface DDContactFormSectionProps {
  title?: string;
...
const benefits = [
  ...
  },
  {
    ...
    desc: "We start building your claim right away.",
  },
];

export default function DDContactFormSection({
  title = "Get a Free Case Review From a Drunk Driving Accident Lawyer in Florida",
  highlightedText = "FREE CASE REVIEW",
  paragraph = "A drunk driver caused an accident and their insurer is already working to limit your payout. Our drunk driving accident lawyer Florida at McCulloch Law reviews your case free of charge and starts building your claim right away.",
            ...
            <div className="bg-[#0d1f30] rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
              <div className="text-center mb-6">
                ...
                <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Fill out the form below and an experienced Florida drunk driving accident attorney will review your claim.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-10 space-y-4">
                  ...
                  <p className="text-slate-400 text-sm text-center max-w-xs">
                    A McCulloch Law attorney will review your accident details confidentially.
                  </p>
                </div>
              ) : (
