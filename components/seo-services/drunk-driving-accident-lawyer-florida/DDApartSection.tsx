...
export interface DDApartSectionProps {
  title?: string;
  rows?: ApartRow[];
}
...
const defaultRows: ApartRow[] = [
  {
    feature: "Liability sources pursued",
    mcculloch: "Dram shop, commercial and rideshare policies",
    others: "Just the drunk driver's policy",
  },
  {
    feature: "Trial leverage",
    mcculloch: "100+ verdicts, uncapped punitive damage exposure",
    others: "A quick settlement offer",
  },
  {
    feature: "Response time",
    mcculloch: "Available 24/7 after a crash",
    others: "Office hours only",
  },
  {
    feature: "Caseload",
    mcculloch: "Limited intake, licensed attorneys handle every file",
    others: "High volume caseloads spread thin",
  },
  {
    feature: "Pricing",
    mcculloch: "Zero upfront fees, contingency only",
    others: "Hidden costs inside the retainer",
  },
  {
    feature: "Negotiation stance",
    mcculloch: "A former prosecutor dismantles insurer tactics",
    others: "A standard demand letter, then wait",
  },
];

export default function DDApartSection({
