...
export interface DDHeroSectionProps {
  bgImagePath?: string;
...
export default function DDHero({
  ...
  paragraph1 = "Sometimes drunk driving doesn't only cause minimal auto accidents. In worst case, driving while being drunk kills innocent lives. DUI creates civil liability for every dollar you've lost since the crash. If you lost your loved one in alchohol related auto accident or you narrow escaped from such crash, McCulloch Law is here to help. For over 15 years, our drunk driving accident lawyer florida have delivered compassionate yet assertive representation for clients in Florida. Our team will work tirelessly to ensure that you receive the highest amount of compensation available for your losses.",
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-stretch gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex flex-col items-center justify-end relative min-h-[380px] sm:min-h-[460px] md:min-h-[520px] lg:min-h-[580px]">
            <div className="relative w-full h-[380px] sm:h-[460px] md:h-[520px] lg:h-[580px] flex items-end justify-center lg:justify-start lg:pl-2 xl:pl-6">
              <Image
                src={personImagePath}
                alt="Florida Drunk Driving Accident Lawyer"
                fill
                priority
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-800">
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4 first:pl-0">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Florida Drunk Driving <br className="hidden sm:inline" /> Accident Lawyers
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                15+ Years Experience <br className="hidden sm:inline" /> Fighting for Victims
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Uncapped Punitive <br className="hidden sm:inline" /> Damages Pursuit
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4 sm:pt-0 sm:px-4">
              ...
              <span className="text-sm sm:text-base font-semibold text-slate-100 leading-snug">
                Zero Upfront Fees <br className="hidden sm:inline" /> Contingency Only
              </span>
            </div>
          </div>
        </div>
