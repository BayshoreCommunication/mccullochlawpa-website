...
export interface DDFreeCaseReviewSectionProps {
  title?: string;
  paragraph?: string;
  phoneNumber?: string;
...
export default function DDFreeCaseReviewSection({
  title = "Hit by a Drunk Driver in Florida? Contact McCulloch Law",
  paragraph = "Every hour after your accident is an hour the insurance company spends building their defense. Call (813) 444-2817 now and put a Florida drunk driving accident lawyer on your side. McCulloch Law, P.A. sits at 238 E Davis Blvd, Suite 202 Tampa, FL 33606. Consultations stay free and confidential, every single time, for every caller.",
